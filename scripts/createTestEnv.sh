...
helpFunction()
{
   ...
   echo ""
   echo "REQUISITOS: instalar os clis:" 
   ...
   echo ""
   echo "IMPORTANTE:" 
   echo "1. É necessário ter criado o namespace em um projeto do cluster dev-test rancher. Ex: fulano-teste"
   echo "2. Adicionar o repositório de Charts localmente"
...
if [ $? -eq 1 ]; then  echo "Namespace $namespace não existe. Favor criar/verificar"; exit 1; fi
